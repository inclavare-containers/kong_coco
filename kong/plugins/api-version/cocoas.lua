...
function cocoas.Verify(plugin_conf)
    -- 定义要执行的curl命令  
    local curl_command = "curl -k -X POST http://127.0.0.1:8080/attestation -H 'Content-Type: application/json' -d  @/home/wydx/kong_coco/kong/plugins/api-version/data/restful-request.json"
