...
function cocoas.Verify(plugin_conf)
    -- 定义要执行的curl命令  
    local curl_command = "curl -k -X POST http://172.19.0.2:8080/attestation -H 'Content-Type: application/json' -d  @/home/wydx/kong/kong/plugins/key-auth-modified/restful-request.json"  
